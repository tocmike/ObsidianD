...
生成一张 3×3 的分镜九宫格图片，主题为日系动漫风格的少女乐队演唱会场景，采用新海诚动画美学风格，暖橙黄色调的日落光影氛围，舞台上飘着彩色纸屑与光斑；每个分镜格子清晰标注对应的镜头术语（ELS 超远景、LS 远景、MLS 中远景、MS 中景、MCU 中近景、CU 特写、ECU 极特写、Low Angle 低角度、High Angle 高角度），依次呈现：1. ELS 超远景展现演唱会全场舞台与观众的热闹场面；2. LS 远景聚焦乐队整体表演姿态；3. MLS 中远景突出主唱与乐队的互动；4. MS 中景展示主唱弹吉他的上半身动作；5. MCU 中近景捕捉主唱面部与麦克风的特写衔接；6. CU 特写放大主唱的脸部神情；7. ECU 极特写聚焦吉他弦与拨片的细节；8. Low Angle 低角度仰拍主唱演唱的飒爽姿态；9. High Angle 高角度俯拍主唱与舞台的整体画面；画面线条细腻，光影柔和，少女主唱为棕色短发、身着校服风乐队制服，背景可见乐队其他成员与舞台设备，分镜标注文字清晰且与画面匹配。

基于上述 3×3 分镜九宫格的镜头运镜逻辑，生成一段 30 秒的流畅动漫风格 MV 视频，采用新海诚式日系动画质感，60fps 高帧率保证画面丝滑；核心内容为日系少女乐队的演唱会现场，棕色短发的少女主唱身着校服风乐队制服，手持吉他对着麦克风深情演唱，舞台被暖橙黄色的日落光影包裹，空中飘落的彩色纸屑与光斑营造梦幻氛围；镜头严格按照分镜的术语切换：从 ELS 超远景拉镜至 LS 远景，再推镜到 MLS 中远景，接着慢推至 MS 中景、MCU 中近景，切镜到 CU 特写与 ECU 极特写，再切换 Low Angle 低角度仰拍和 High Angle 高角度俯拍，每个镜头转换自然流畅；背景可见模糊的观众欢呼剪影与舞台灯光设备，人物动作（弹吉他、演唱）精准且富有动感，音乐现场的氛围感拉满，色彩饱和度适中，光影层次丰富，整体画面符合日系动漫的细腻质感与审美。
