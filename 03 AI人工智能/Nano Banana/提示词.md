...
### 潦草白板
将笔记转化为结构化的、照片般逼真的白板, 字体为非常非常潦草几乎认不出来的手写体，即使文字很小，也要做到真正超详细。
...
### 儿童蜡笔画
Nano Banana Pro 提示：像一个开朗的 6 岁孩子在白色笔记本纸上创作的画面一样绘制[小朋友在草地放风筝]。使用粗糙的蜡笔笔触、摇晃的轮廓和简单的平面形状。颜色应当明亮、粗犷，略微超出边界，带有明显的压力痕迹和小污迹。透视是无害的：物体可以漂浮，尺寸基于重要性而非真实性。脸部是带着弧度微笑的点状; 手是连指手套状的团块; 动物是圆润且友好的。添加有趣的额外元素，比如角落里的太阳、蓬松的云朵、星星和爱心。可以加上不均匀的涂鸦、边缘几处小涂鸦，以及一两个用孩子般拼写的中文手写标签（儿童手写体）。
...
{
  "style": {
    "name": "纯净影棚人像 (clean_studio_portrait)",
    "description": "写实摄影棚风格肖像，采用柔和且受控的光线，保留自然的皮肤细节，极简编校感外观，完整面部及头发清晰可见。",
    "elements": {
      "subject": {
        "type": "人像",
        "composition": "脸部特写构图，中心对齐，完整头发入画",
        "expression": "冷静，中性",
        "lighting": "柔和扩散的专业影棚灯光",
        "skin_texture": "自然，逼真，未经修饰",
        "wardrobe": "简单的纯色中性服装"
      },
      "background": {
        "type": "无缝影棚背板",
      ...
      "color_palette": {
        ...
        "overall_tones": "柔和中性色调",
        "accent_colors": "无",
        "contrast_level": "中等，平衡"
      },
      "camera": {
        "lens": "等效 85mm 人像镜头",
        "depth_of_field": "浅景深",
        "focus_point": "对焦点为眼睛，且头部与头发全景入框",
        "camera_angle": "平视，齐眼高度"
      }
    }
  },
  "output": {
    "type": "纯净影棚人像",
    "resolution": "高分辨率",
    "quality_priority": "最高写实度，在完整保留头发可见的前提下维持原始身份特征"
  }
}
```
...
提示：{
 ...
 “描述”：“人物性侧脸姿态，转身回望观众。”
 “姿势”：“回头看，头微微倾斜，身体背离镜头。”
 “表情”：“柔和，中性到略带忧郁，沉思的目光，嘴唇微张。”
 },
 “服装”：{
 “Upper_body”：“深色、结构感十足的夹克或西装外套，可能为细条纹或有纹理的面料。”
 “可见度”：“大部分被阴影和前景元素遮挡。”
 },
 “头发”：{
 “颜色”：“深棕色到黑色。”
 “风格”：“松散、凌乱，质感略显凌乱。”
 “Lighting_interaction”：“强烈背光，在松散发丝上形成发光光晕效果（边缘灯光）。”
 },
 “脸”：{
 “Skin_tone”：“肤色白皙，带有温暖底色。”
 “特征”：“柔和的面部结构，杏仁形眼睛，自然的眉毛。”
 “化妆”：“极简，'无妆'妆，自然唇色。”
 },
 “配件”：{
 “Visible_items”：“由于构图和光线原因，没有明显可见。”
 },
 “环境”：{
 “环境”：“杂乱的内部空间，类似作坊、储藏室或老书店。”
 “Background_elements”：“木质货架堆满了模糊的物品、纸张、盒子和塑料包装。”
 “Foreground_elements”：“模糊的半透明物体（可能是玻璃、塑料片或防尘罩）形成层次和反光。”
 },
 “闪电”：{
 “来源”：“自然阳光透过左侧窗户洒进来。”
 “质量”：“黄金时刻，温暖、弥漫但有方向性。”
 “特效”：“强烈的背光/边缘光照射头发，体积状的尘埃颗粒在光线中跳动，镜头光晕，柔和的眩光，光影的戏剧性对比。”
 },
 “相机”：{
 “透视”：“视线高度，透过前景障碍物（玻璃或杂物）拍摄。”
 “对焦”：“浅景深（散景），眼睛/面部清晰对焦，背景和前景模糊。”
 “Lens_character”：“柔焦，胶片颗粒模拟，轻微的晕染效果。”
 },
 “风格”：{
 “美学”：“电影感、氛围感十足、怀旧、生活切片、空灵。”
 “氛围”：“梦幻、亲密、安静、感伤。”
 “Visual_reference”：“胶片摄影，日本摄影集风格。”
 }
}
...
```json
{
  ...
  "outfit": {
    ...
    "top": "纯色圆领衫或轻薄针织衫",
    "layer": "休闲西装外套或非结构化夹克",
    "colors": "{argument name=\"outfit colors\" default=\"大地色系或中性色调，米色、橄榄色、炭灰色\"}",
    "styling": "轻松现代，而非正式"
  },
  "camera": {
    "framing": "特写头部和上半身",
