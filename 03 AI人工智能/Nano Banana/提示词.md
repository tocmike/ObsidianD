...
"{ "style": "写实香港复古肖像", "era": "90 年代电影风格", "subject": { "reference_face": "image[0]", "framing": "半身像", "pose": "倚靠在贴满报纸的墙上", "expression": "柔和的眼神", "hair": "凌乱的碎发", "makeup": { "lips": "光泽感", "skin": "水润光泽" } }, "environment": { "location": "狭窄的香港房间", "walls": "泛黄的旧粤语报纸", "foreground": "模糊的毛茸茸的白猫" }, "lighting": { "type": "钨丝灯泡的光芒", "color_cast": "淡淡的绿色光晕", "shadows": "浓重的阴影", "highlights": "明亮的高光" } }"
