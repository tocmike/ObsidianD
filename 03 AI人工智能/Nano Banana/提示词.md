...
{
  "edit_instructions": {
    "prompt": "A photorealistic medium shot of a stunning young person with voluminous wavy blonde hair, posing with both hands raised touching their head, elbows pointing out. They are wearing a tight strapless mini-dress constructed from wrapped and folded layers of newspaper pages. The dress features visible black text, headlines, and newspaper layout. The background is a wall completely wallpapered with sheets of newspaper, creating a textured monochrome backdrop that matches the dress. Soft, even natural lighting, high fashion photography style, sharp focus, highly detailed skin texture, 8k resolution, cinematic look.",
    "negative_prompt": ""
  },
  "settings": {
    "strength": 0.7,
